...
func main() {
	...
	fmt.Printf("Topic exchange queue=%s routing_key=%s binding_exchange=%s created", os.Getenv("QUEUE"), os.Getenv("ROUTING_KEY"), exchangeName)
}
